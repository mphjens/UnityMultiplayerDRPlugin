...
namespace UnityMultiplayerDRPlugin
{
    class UMGameDBInitializer : DropCreateDatabaseAlways<UMGameDatabaseContext>
    {
        protected override void Seed(UMGameDatabaseContext context)
        {
            ...
            ItemData IronItem = new ItemData() { Name = "Iron", EntityID = 99, Value = 19.00f, StackSize = ushort.MaxValue - 1, Description = "" };
            Items.Add(IronItem);

            ItemData OilItem = new ItemData() { Name = "Oil", EntityID = 99, Value = 19.00f, StackSize = ushort.MaxValue - 1, Description = "" };
            Items.Add(OilItem);

            ItemData CopperItem = new ItemData() { Name = "Copper", EntityID = 99, Value = 19.00f, StackSize = ushort.MaxValue - 1, Description = "" };
            Items.Add(CopperItem);

            ItemData WheatItem = new ItemData() { Name = "Wheat", EntityID = 99, Value = 19.00f, StackSize = ushort.MaxValue - 1, Description = "" };
            Items.Add(WheatItem);

            ItemData CornItem = new ItemData() { Name = "Corn", EntityID = 99, Value = 19.00f, StackSize = ushort.MaxValue - 1, Description = "" };
            Items.Add(CornItem);
            ...
            admininventory.Items.Add(new InventoryItem() { Inventory = admininventory, ItemData = CornItem, Quantity = 10, Position = 0 });
